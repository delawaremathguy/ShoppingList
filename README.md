...
Note. The SearchBarView in the Purchased items view was created by Simon Ng.  It appeared in an article in AppCoda and is copyright © 2020 by AppCoda. You can find it on GitHub under AppCoda/SwiftUISearchBar.  The extension I use on Bundle to load JSON files is due to Paul Hudson (@twostraws, hackingwithswift.com) Otherwise, almost all of the code is original,  and It's yours if you want it -- please see LICENSE for the usual details and disclaimers.
